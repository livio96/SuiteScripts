...
function schedulerFunction_amzonadjustment(type){
	...
	try {
		...
		/*
		 ...
		 column[2] = new nlobjSearchColumn('location', 'inventorynumber', 'group');
		 column[3] = new nlobjSearchColumn('internalid', 'inventorynumber', 'count');
		 
		 var ItemSearchRes = nlapiSearchRecord('item', 'customsearch_concat_amz_serialnumber', filter, column);
		 ...
		 var item_search = nlapiLoadSearch('item', 'customsearch_concat_amz_serialnumber_2');
		 ...
		 */
		{
			var NegativeInvObj = nlapiLoadRecord('inventoryadjustment', 17924086)
