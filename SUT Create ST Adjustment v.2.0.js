...
define(['N/record','N/search','N/runtime','N/format'],
    ...
    var ItemSerialExp = [
        ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['custrecord_smt_sn_apply', 'is', 'T'], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
            ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1], "OR", ["formulanumeric: case when {custrecord_smt_sn_serial} != {custrecord_smt_sn_sn} then 1 else 0 end", "equalto", 1]
        ]
    ];

    if (SNLineRecID != null && SNLineRecID != '' && SNLineRecID != undefined) {
        ItemSerialExp = [
            ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['internalid', 'anyOf', SNLineRecID], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1], "OR", ["formulanumeric: case when {custrecord_smt_sn_serial} != {custrecord_smt_sn_sn} then 1 else 0 end", "equalto", 1]
            ]
        ];
    }
    ...
    if (ItemandSerialSearch != null && ItemandSerialSearch != '' && ItemandSerialSearch != undefined) {
        for (var q = 0; q < ItemandSerialSearch.length; q++) {
            ...
            if (Isserial == true) {
                ...
                o_InvAdjust_OBJ.setCurrentSublistValue({
                    sublistId: 'inventory',
                    fieldId: 'adjustqtyby',
                    value: -Math.abs(NonSerialQuantity), // Ensure negative value
                });
            }
            ...
            var LineItemserialExp = [
                ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['custrecord_smt_sn_apply', 'is', 'T'], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_item', 'anyOf', Item], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                    ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1], "OR", ["formulanumeric: case when {custrecord_smt_sn_serial} != {custrecord_smt_sn_sn} then 1 else 0 end", "equalto", 1]
                ]
            ];
        ...
        var AddItemSearchExp = [
            ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['custrecord_smt_sn_apply', 'is', 'T'], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1]
            ]
        ]
            ...
            for (var q = 0; q < AddItemSearch.length; q++) {
                ...
                if (Isserial == true) {
                    ...
                    o_InvAdjust_OBJ.setCurrentSublistValue({
                        sublistId: 'inventory',
                        fieldId: 'adjustqtyby',
                        value: Math.abs(NonSerialQuantity), // Ensure positive value
                    });
                }
                ...
                var Line_AddItemSearchExp = [
                    ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['custrecord_smt_sn_apply', 'is', 'T'], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_item', 'anyOf', OldItem], "AND", ['custrecord_smt_sn_part_number_update', 'anyOf', Item], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                        ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1]
                    ]
                ]

                if (SNLineRecID != null && SNLineRecID != '' && SNLineRecID != undefined) {
                    Line_AddItemSearchExp = [
                        ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['internalid', 'anyOf', SNLineRecID], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_item', 'anyOf', OldItem], "AND", ['custrecord_smt_sn_part_number_update', 'anyOf', Item], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                            ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 1]
                        ]
                    ]
        ...
        var AddSerialExp = [
            ['custrecord_smt_sn_location', 'anyOf', Location], "AND", ['custrecord_smt_sn_apply', 'is', 'T'], "AND", ['custrecord_smt_sn_processed', 'is', 'F'], "AND", ['custrecord_smt_sn_testupdate', 'noneOf', '@NONE@'], "AND", ['custrecord_smt_sn_correcting_transaction', 'anyOf', '@NONE@'], "AND", ['custrecord_smt_sn_smart_testing', 'anyOf', STrecId], "AND", [
                ["formulanumeric: case when {custrecord_smt_sn_item} ! = {custrecord_smt_sn_part_number_update} then 1 else 0 end", "equalto", 0], "AND", ["formulanumeric: case when {custrecord_smt_sn_serial} != {custrecord_smt_sn_sn} then 1 else 0 end", "equalto", 1]
            ]
        ];
        ...
        if (AddSerialSearch != null && AddSerialSearch != '' && AddSerialSearch != undefined) {
            for (var q = 0; q < AddSerialSearch.length; q++) {
                ...
                if (Isserial == true) {
                    ...
                    log.debug('NonSerialQuantity', NonSerialQuantity)
                    o_InvAdjust_OBJ.setCurrentSublistValue({
                        sublistId: 'inventory',
                        fieldId: 'adjustqtyby',
                        value: NonSerialQuantity,
